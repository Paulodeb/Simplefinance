...
const BulkTransferHistory = () => {
  return (
    <div>
    <div className='d-flex flex-column'> 
      <div className='d-flex flex-wrap w-100 justify-content-between'>
        <div className='col-md-5 d-flex mb-3 col-12'>
          <input type='text' placeholder= 'Thursday, Oct 6, 2022-Friday, Oct 7, 2022' className='w-100 form-control' />
        </div>
        <div className=' '>
...
export default BulkTransferHistory