  ...
  return (
    ...
    <div className="col-10">
      ...
      <div className="mt-4 container">
        ...
        <NavLink className='text-decoration-none border-bottom pe-3' to='/subscription/transaction-log'>
        Recent Transaction Log
        </NavLink>
        <NavLink className='text-decoration-none border-bottom pe-3' to='/subscription/wallet-access'>
        Wallet Access
        </NavLink>
        <NavLink className='text-decoration-none border-bottom pe-3' to='/subscription/reset-wallet-pin'>
       Reset Wallet Pin
        </NavLink>
        <NavLink className='text-decoration-none border-bottom pe-3' to='/subscription/bulk-transfer-history'>
        Bulk Transfer History
        </NavLink>
        <NavLink className='text-decoration-none border-bottom' to='/subscription/statement-of-account'>
